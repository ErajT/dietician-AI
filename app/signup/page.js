...
const SignupPage = () => {
  ...
  const handleChange = (e) => {
    ...
    console.log("Field Name:", name); // Branch point
    console.log("New Value:", value); // Branch point
    setFormData({ ...formData, [name]: value });
  };

  const handleSubmit = (e) => {
    e.preventDefault();
    console.log("Form Data Submitted:", formData); // Branch point

    if (!formData.name || !formData.age || !formData.height || !formData.weight) {
      console.log("Form submission failed, incomplete data"); // Branch point
      return;
    }
    
    localStorage.setItem('formData', JSON.stringify(formData));
    console.log("Form Data saved to localStorage"); // Branch point
    router.push('/Home');
  };
